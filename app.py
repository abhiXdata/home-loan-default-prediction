...
def render_footer():
    ...
    <div class="footer-container">
        <div class="footer-text">
            Built using 
            <a href="https://www.python.org/" target="_blank" class="footer-link">Python</a>, 
            <a href="https://pandas.pydata.org/" target="_blank" class="footer-link">Pandas</a>, 
            <a href="https://scikit-learn.org/" target="_blank" class="footer-link">Scikit-Learn</a>, 
            <a href="https://plotly.com/" target="_blank" class="footer-link">Plotly</a> and 
            <a href="https://streamlit.io/" target="_blank" class="footer-link">Streamlit</a>.
        </div>
        <div class="footer-text">
            💻 Developed with ❤️ by 
